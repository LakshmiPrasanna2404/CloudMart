...
CUSTOMERS_TOKEN_PARAMETER_NAME = os.environ.get(
    "CUSTOMERS_TOKEN_PARAMETER_NAME",
    "",
)
...
_token_cache = {
    ...
    "customer": {"value": None, "fetched_at": 0},
}
...
def get_role_for_token(incoming_token):
    token_sources = [
        ...
        ("customer", CUSTOMERS_TOKEN_PARAMETER_NAME),
    ]
...
def get_route_permission(method, path):
    ...
    The customer role is intentionally allowed to browse products because a
